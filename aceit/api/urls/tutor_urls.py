...
urlpatterns = [
    ...
    path('tutor/test/<int:test_id>/', TutorTestRetrieveUpdateDestroyView.as_view(), name='test-retrieve-update-destroy'),
    path('tutor/<int:test_id>/questions/<int:question_id>/', QuestionTutorAPIView.as_view(), name='question-detail'),
    path('tutor/<int:test_id>/', QuestionTutorCreateAPIView.as_view(), name='add-question'),
]
